...
export const initialNodes = [
  {
    ...
    data: { label: 'MATH 205',
            ...
            description: 'Linear differential equations and applications; matrices and systems of linear equations; vector spaces; eigenvalues and application to linear systems of differential equations.'},
    position,
  ...
  },
  {
    ...
    data: { label: 'MATH 022',
            title: 'Calculus II',
            description: 'Applications of integration; techniques of integration; separable differential equations; infinite sequences and series; Taylor\'s Theorem and other approximations; curves and vectors in the plane.'},
    position,
    style: styleUnselected,
  },
  {
  ...
  },
  {
    ...
    data: {label: 'BUS 203',
           ...
           description: 'This course builds on the basic communication frameworks and skills from BUS 003 to enhance students’ business communications related to data, particularly oral communication. Students will translate data and analysis into narratives that provide context for their messages and make persuasive recommendations in written and oral formats.'},
    position,
    style: styleUnselected,
  },
  {
    ...
    data: {label: 'FIN 125',
           ...
           description: 'An introductory finance course stressing the links between corporate finance and investments. Major topic areas will include financial statement analysis, time value of money, risk and return valuation of stocks and bonds, capital budgeting, and cost of capital.'},
    position,
    style: styleUnselected,
  },
  {
  ...
  },
  {
    ...
    data: {label: 'ECO 119/146',
           ...
           description: 'Macroeconomic measurement, theory and policy. The use of alternative macroeconomic models to analyze the level of national income, inflation, unemployment, economic growth; the balance of payments, and exchange rate determination.\nThe application of economic analysis to managerial and public policy decision-making. Not available for credit to students who have taken ECO 105.'},
    position,
    style: styleUnselected,
  },
  {
    ...
    data: { label: 'ENGL 001',
            ...
            description: 'Introduction to academic writing that supports a claim in respectful conversation with others. Topics drawn from important issues in the world in which students live. The course provides multiple opportunities to engage thoughtfully in the writing process. Students must receive a grade of C- or higher to advance to English 2.'},
    position,
    style: styleAvailable,
  },
  {
    ...
    data: {label: 'ECO 001',
           ...
           description: 'A one-semester course in the principles of economics. General topics covered are: supply and demand; pricing and production decisions of firms; the role of government in the economy; the determination of national income; money and banking; monetary and fiscal policy; and government finance.'},
    position,
    style: styleAvailable,
  },
  {
    ...
    data: {label: 'ECO 045',
           ...
           description: 'Descriptive statistics, probability and probability distributions, sampling, estimation, hypothesis testing, chi-square tests, simple regression and correlation. Note: College of Business students may not take MATH 012 as a replacement for ECO 045.'},
    position,
    style: styleAvailable,
  },
  {
  ...
  },
  {
    ...
    data: {label: 'CSE 340',
           ...
           description: 'Algorithms for searching, sorting, manipulating graphs and trees, finding shortest paths and minimum spanning trees, scheduling tasks, etc.: proofs of their correctness and analysis of their asymptotic runtime and memory demands. Designing algorithms: recursion, divide-and-conquer, greediness, dynamic programming. Limits on algorithm efficiency using elementary NP-completeness theory.'},
    position,
    style: styleUnselected,
  },
  {
  ...
  },
  {
    ...
    data: {label: 'CSE 216',
           ...
           description: 'The software lifecycle; lifecycle models; software planning; testing; specification methods; maintenance. Emphasis on team work and large-scale software systems, including oral presentations and written reports.'},
    position,
    style: styleUnselected,
  },
  {
    ...
    data: {label: 'CSE 241/341',
           ...
           description: 'Design of large databases; normalization; query languages (including SQL); Transaction-processing protocols; Query optimization; performance tuning; distributed systems. Not available to students who have credit for CSE 241.'},
    position,
    style: styleUnselected,
  },
  {
    ...
    data: {label: 'CSE 252',
           ...
           description: 'An interactive exploration of the current and future role of computers, the Internet, and related technologies in changing the standard of living, work environments, society and its ethical values. Privacy, security, depersonalization, responsibility, and professional ethics; the role of computer and Internet technologies in changing education, business modalities, collaboration mechanisms, and everyday life.'},
    position,
    style: styleUnselected,
  },
  {
  ...
  },
  {
    ...
    data: {label: 'CSE 017',
           ...
           description: 'Algorithmic design and implementation in a high level, object oriented language, such as Java. Classes, subclasses, recursion, searching, sorting, linked lists, trees, stacks, queues.'},
    position,
    style: styleUnselected,
  },
  {
    ...
    data: {label: 'CSE 007',
           ...
           description: 'Problem-solving using the Java programming language. Data types, control flow, methods, arrays, objects, inheritance, breadth of computing. Includes laboratory. If credit is given for CSE 007 then no credit will be given for CSE 003 nor CSE 004.'},
    position,
    style: styleAvailable,
  },
];
